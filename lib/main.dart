...
import 'package:benitez/paginas_tabs/pagina1.dart';
import 'package:benitez/paginas_tabs/pagina2.dart';
import 'package:benitez/paginas_tabs/pagina3.dart';
...
class MiCasaState extends State<MiCasa> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Appbar
      appBar: AppBar(
        title: Text("Bottom Navigation Bar de Benitez"),
